...
public class SaveFileActivity extends AppCompatActivity {
    ...
    protected static Boolean readyToSave = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        savefileView = li.inflate(R.layout.save_file, null);
        fileName = (EditText) savefileView.findViewById(R.id.file_name);
        Button btnOk = (Button) savefileView.findViewById(R.id.btn_ok);
        ...
        dialog  .setTitle("save current game")
                //.setMessage("save current game")
            ...
            public void onClick(View v) {
                ...
                if (!exist) {
                    ...
                    if (fileList.contains(tempName) ) {
                        ...
                        fileName.setText(tempName + " EXISTS, RENEW IT ?");
                        exist = true;
                        return;
                    }
                }
        ...
        listDir.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(!exist) fileName.setText(parent.getAdapter().getItem(position).toString());
            }
        });
    }
